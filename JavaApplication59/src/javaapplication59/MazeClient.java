...
public class MazeClient extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
           MazeClient client = new MazeClient("172.31.79.168"); 
    }
...
try{
        ...
        pacman2down = ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman3down =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman4down =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman2left =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman3left =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman4left = ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman2right =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman3right =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));
        pacman4right =  ImageIO.read(new File("20x20_png_icons_brian_by_jmcivor.png"));}
catch(IOException e){

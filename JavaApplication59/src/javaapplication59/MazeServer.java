...
public class MazeServer extends JFrame {
    ...
    private void loadImages() {
       ...
       try{
        ...
        pacman4up =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman2down = ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman3down =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman4down =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman2left =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman3left =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman4left = ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman2right =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman3right =  ImageIO.read(new File("20x20_png_icons_avatar_by_jmcivor.png"));
        pacman4right =  ImageIO.read(new File("20x20_png_icons_avatar"
                + "_by_jmcivor.png"));}
catch(IOException e){
